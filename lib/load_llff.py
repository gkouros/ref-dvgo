...
def _load_data(basedir, factor=None, width=None, height=None, load_imgs=True, load_depths=False, mask_imgs=False):
...
def load_llff_data(basedir, factor=8, width=None, height=None, recenter=True,
                   rerotate=True, bd_factor=.75, spherify=False, path_zflat=False,
                   load_depths=False, movie_render_kwargs={}, mask_imgs=False):

    poses, bds, imgs, *depths = _load_data(basedir, factor=factor, width=width, height=height,
                                           load_depths=load_depths, mask_imgs=mask_imgs) # factor=8 downsamples original imgs by 8x
